...
func snapshotEnv() map[string]string {
	...
	for _, k := range []string{
		...
		"LLM_RAM_BUDGET", "LLM_KV_PLACEMENT", "LLM_ASSUME_YES",
		"LLM_BACKEND", "LLAMA_SERVER", "LLM_APP_HOME",
	} {
		if v := os.Getenv(k); v != "" {
			m[k] = v
		}
